...
public class Reserva implements VOReserva {
	 ...
	 */
	public Reserva(long id, long idCliente, long idHabitacion, Timestamp fechaReserva,
	...
	/**
	 * @param idCliente - El nuevo idCLiente. Debe exixtir un cliente con dicho
	 *                  identificador
	 */
	...
	/**
	 * @param idHabitacion - El nuevo idHabitacion. Debe exixtir una habitacion con
	 *                     dicho identificador
	 */
	...
	/**
	 * @param fechaReserva - La nueva fecha de reserva a la habtiacion por el
	 *                     cliente
	 */
	...
	public String toString() {
		return "Reserva [id=" + id + ", idCliente=" + idCliente + ", idHabitacion=" + idHabitacion + ", fechaReserva="
				+ fechaReserva + ", fechaCancelacionOportuna=" + fechaCancelacionOportuna + ", fechaCancelacion="
				+ fechaCancelacion + "]";
	}
}
