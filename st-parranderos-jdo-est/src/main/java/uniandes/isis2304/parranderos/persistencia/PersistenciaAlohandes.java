...
public class PersistenciaAlohandes {
	...
	/**
	 * Método que elimina, de manera transaccional, una tupla en la tabla
	 * HABITACION, dado el identificador de habitacion
	 * Adiciona entradas al log de la aplicación
	 * 
	 ...
	 * 
	 * @return La lista de objetos Habitacion, construidos con base en las tuplas de
	 *         la tabla HABITACION
	 */
	 ...
	 * @return El objeto Habitacion, construido con base en las tuplas de la tabla
	 *         HABITACION con el identificador dado
	 */
	 ...
	 * Adiciona entradas al log de la aplicación
	 * 
	 * @param idCliente                - El identificador del cliente. Debe existir
	 *                                 un cliente con dicho identificador
	 * @param idHabitacion             - El identificador de la habitacion. Debe
	 *                                 exixtir una habitacion con dicho
	 *                                 identificador
	 * @param fechaReserva             - La fecha en la cual se realiza la reserva
	 * @param fechaCancelacionOportuna - La fecha en la cual se puede cancelar la
	 *                                 reserva
	...
	public Reserva adicionarReserva(long idCliente, long idHabitacion, Timestamp fechaReserva,
		...
		try {
			...
			log.trace("Inserción de reserva: " + idCliente + idHabitacion + ": " + tuplasInsertadas
					+ " tuplas insertadas");
	...
	/**
	 * Método que elimina, de manera transaccional, una tupla en la tabla
	 * VINCULADOUNIANDES, dado el identificador de la reserva
	 * Adiciona entradas al log de la aplicación
	 * 
	...
	/**
	 * Método que consulta todas las tuplas en la tabla Reserva con un identificador
	 * dado
	 * 
	 * @param id - El identificador de la reserva
	 * @return El objeto Reserva, construido con base en las tuplas de la tabla
	 *         RESERVA con el identificador dado
	 */
	...
	public List<Object[]> darDineroProveedorActualCorrido(String fechaActual) {
		return sqlHotel.darDineroProveedorActualCorrido(pmf.getPersistenceManager(), fechaActual);
	}
	...
	/**
	 * RFC3 - MOSTRAR LOS ALOJAMIENTOS DISPONIBLES EN UN RANGO DE FECHAS, QUE
