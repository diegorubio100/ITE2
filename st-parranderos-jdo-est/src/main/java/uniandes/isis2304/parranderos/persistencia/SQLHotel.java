...
public class SQLHotel {
    ...
    public List<Object[]> darDineroProveedorActualCorrido(PersistenceManager pm, String fechaActual) {
        ...
        query += "    SUM(CASE WHEN A_Reserva.fechaReserva BETWEEN '01/01/" + anio + "' AND '31/12/" + anio
                + "' THEN A_HabitacionHotel.precioNoche ELSE 0 END) AS Actual, ";
        query += "    SUM(CASE WHEN A_Reserva.fechaReserva BETWEEN '01/01/" + anio + "' AND '" + fechaActual
                + "' THEN A_HabitacionHotel.precioNoche ELSE 0 END) AS Corrido";
        query += "    FROM A_Hotel";
        ...
        query += "    SUM(CASE WHEN A_Reserva.fechaReserva BETWEEN '01/01/" + anio + "' AND '31/12/" + anio
                + "' THEN A_HabitacionHostal.precioNoche ELSE 0 END) AS Actual, ";
        query += "    SUM(CASE WHEN A_Reserva.fechaReserva BETWEEN '01/01/" + anio + "' AND '" + fechaActual
                + "' THEN A_HabitacionHostal.precioNoche ELSE 0 END) AS Corrido";
        query += "    FROM A_Hostal";
        ...
        query += "    SUM(CASE WHEN A_Reserva.fechaReserva BETWEEN '01/01/" + anio + "' AND '31/12/" + anio
                + "' THEN A_HabitacionFenicia.precio ELSE 0 END) AS Actual, ";
        query += "    SUM(CASE WHEN A_Reserva.fechaReserva BETWEEN '01/01/" + anio + "' AND '" + fechaActual
                + "' THEN A_HabitacionFenicia.precio ELSE 0 END) AS Corrido";
        ...
        query += "    SUM(CASE WHEN A_Reserva.fechaReserva BETWEEN '01/01/" + anio + "' AND '31/12/" + anio
                + "' THEN A_ApartamentoComunidad.precio ELSE 0 END) AS Actual, ";
        query += "    SUM(CASE WHEN A_Reserva.fechaReserva BETWEEN '01/01/" + anio + "' AND '" + fechaActual
                + "' THEN A_ApartamentoComunidad.precio ELSE 0 END) AS Corrido";
        ...
        query += "    SUM(CASE WHEN A_Reserva.fechaReserva BETWEEN '01/01/" + anio + "' AND '31/12/" + anio
                + "' THEN A_Vivienda.precio ELSE 0 END) AS Actual, ";
        query += "    SUM(CASE WHEN A_Reserva.fechaReserva BETWEEN '01/01/" + anio + "' AND '" + fechaActual
                + "' THEN A_Vivienda.precio ELSE 0 END) AS Corrido";
        ...
        query += "SUM(CASE WHEN A_Reserva.fechaReserva BETWEEN '01/01/" + anio + "' AND '31/12/" + anio
                + "' THEN A_HabitacionUniversitaria.precio ELSE 0 END) AS Actual, ";
        query += "SUM(CASE WHEN A_Reserva.fechaReserva BETWEEN '01/01/" + anio + "' AND '" + fechaActual
                + "' THEN A_HabitacionUniversitaria.precio ELSE 0 END) AS Corrido";
