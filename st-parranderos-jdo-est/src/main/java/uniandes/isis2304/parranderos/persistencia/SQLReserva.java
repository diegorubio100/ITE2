...
public class SQLReserva {
    ...
    /**
     * Crea y ejecuta la sentencia SQL para adicionar un VISITAN a la base de datos
     * de Parranderos
     * 
     ...
     * @param fechaCancelacionOportuna - La fecha en que se puede realizar la
     *                                 cancelacion sin costo
     * @param fechaCancelacion         - La fecha en que se realizó la cancelacion
     * @return EL número de tuplas insertadas
     */
    public long adicionarReserva(PersistenceManager pm, long id, long idCliente, long idHabitacion,
        ...
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaReserva()
                + "(id, idCliente, idHabitacion, fechaReserva, fechaCancelacionOportuna, fechaCancelacion) values (?, ?, ?, ?, ?, ?)");
        q.setParameters(id, idCliente, idHabitacion, fechaReserva, fechaCancelacionOportuna, fechaCancelacion);
        return (long) q.executeUnique();
    }

    /**
     * Crea y ejecuta la sentencia SQL para eliminar TODAS LAS RESERVAS de la base
     * de datos de Alohandes
     * 
     * @param pm - El manejador de persistencia
    ...
    /**
     * Crea y ejecuta la sentencia SQL para eliminar UNA RESERVA de la base de datos
     * de Alohandes, por sus identificadores
     * 
     * @param pm - El manejador de persistencia
     * @param id - El identificador de la reserva
     * @return EL número de tuplas eliminadas
    ...
    /**
     * Crea y ejecuta la sentencia SQL para ELIMINAR TODAS LAS RESERVAS DE UN
     * CLIENTE
    ...
    /**
     * Crea y ejecuta la sentencia SQL para ELIMINAR TODAS LAS RESERVAS HECHAS A UNA
     * HABITACION de la base de datos de Alohandes, por su identificador
     * 
     * @param pm           - El manejador de persistencia
     * @param idHabitacion - El identificador de la habitacion
     * @return EL número de tuplas eliminadas
    ...
    /**
     * Crea y ejecuta la sentencia SQL para encontrar la información de las RESERVAS
     * de la
    ...
    // "SELECT id, idCliente, idHabitacion, fechaReserva, fechaCancelacionOportuna,
    // fechaCancelacion FROM "
    // + pp.darTablaReserva());
    ...
    // resp.add(
    // new Reserva(id, idCliente, idHabitacion, fechaReserva,
    // fechaCancelacionOportuna));
    // }
    // return resp;
    // }
