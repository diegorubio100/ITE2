...
public class SQLHabitacion 
{
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar HABITACIONES de la base de datos de Parranderos, por su identificador
	 * @param pm - El manejador de persistencia
	 * @param idHabitacion - El identificador de la habitacion
    ...
    /**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de HABITACION de la 
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LAS HABITACIONES de la 
