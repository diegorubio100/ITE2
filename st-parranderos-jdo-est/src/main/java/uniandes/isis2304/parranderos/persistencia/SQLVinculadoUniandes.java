...
public class SQLVinculadoUniandes {
	...
	/**
	 * Crea y ejecuta la sentencia SQL para adicionar un VINCULADO a la base de
	 * datos de Alohandes
	 * 
	 * @param pm          - El manejador de persistencia
	 * @param idVinculado - El identificador del vinculado
	 * @param nombre      - El nombre del vinculado
	 * @param tipo        - El tipo de vinculado ('Estudiante', 'Egresado',
	 *                    'Empleado', 'Acudiente', 'Invitado')
	 * @return El número de tuplas insertadas
	 */
	public long adicionarVinculadoUniandes(PersistenceManager pm, long idVinculado, String nombre, String tipo) {
		Query q = pm.newQuery(SQL,
				"INSERT INTO " + pp.darTablaVinculadoUniandes() + "(id, nombre, tipo) values (?, ?, ?)");
		q.setParameters(idVinculado, nombre, tipo);
		return (long) q.executeUnique();
	}

	/**
	 * Crea y ejecuta la sentencia SQL para eliminar VINCULADOS de la base de datos
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar UN VINCULADO de la base de
	 * datos de Alohandes, por su identificador
	 * 
	 * @param pm          - El manejador de persistencia
	 * @param idVinculado - El identificador del vinculado
	 * @return EL número de tuplas eliminadas
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de UN VINCULADO
	 * de la
